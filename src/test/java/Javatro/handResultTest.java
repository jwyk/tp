...
/**
 * This class contains unit tests for the {@link HandResult} class.
 * It tests various poker hand evaluations to ensure correct identification of hand types.
 */
class HandResultTest {
    ...
    /**
     * Tests that a hand with cards not in sequence is not identified as a straight flush.
     * The hand should be identified as a flush instead.
     */
    @Test
    ...
    /**
     * Tests that a royal flush is correctly identified.
     * A royal flush is a hand that contains the Ace, King, Queen, Jack, and Ten of the same suit.
     */
    @Test
    ...
    /**
     * Tests that a hand with an Ace as a low card is not identified as a royal flush.
     * The hand should be identified as a straight flush instead.
     */
    @Test
    ...
    /**
     * Tests that a flush is correctly identified.
     * A flush is a hand that contains five cards of the same suit, not in sequence.
     */
    @Test
    void testFlushTrue() {
        List<Card> hand = List.of(
    ...
    /**
     * Tests that a hand with mixed suits is not identified as a flush.
     * The hand should be identified as a high card instead.
     */
    @Test
    ...
    /**
     * Tests that a hand with less than five cards is not identified as a flush.
     * The hand should be identified as a high card instead.
     */
    @Test
    ...
    /**
     * Tests that a high card is correctly identified.
    ...
    /**
     * Tests that a straight is correctly identified.
     * A straight is a hand that contains five cards of sequential rank, not all the same suit.
     */
    @Test
    ...
    /**
     * Tests that a hand with cards not in sequence is not identified as a straight.
     * The hand should be identified as a high card instead.
     */
    @Test
    ...
    /**
     * Tests that a hand with mixed sequence is not identified as a straight.
     * The hand should be identified as a high card instead.
     */
    @Test
    ...
    /**
     * Tests that a hand with less than five cards is not identified as a straight.
     * The hand should be identified as a high card instead.
     */
    @Test
    ...
    /**
     * Tests that a full house is correctly identified.
    ...
    /**
     * Tests that a hand with two pairs is not identified as a full house.
     * The hand should be identified as two pairs instead.
     */
    @Test
    ...
    /**
     * Tests that a hand with less than five cards is not identified as a full house.
     * The hand should be identified as two pairs instead.
     */
    @Test
    ...
    /**
     * Tests that a hand with three of a kind is not identified as a full house.
     * The hand should be identified as three of a kind instead.
     */
    @Test
    ...
    /**
     * Tests that three of a kind is correctly identified.
     * Three of a kind is a hand that contains three cards of one rank and two cards of two different ranks.
     */
    @Test
    ...
    /**
     * Tests that a full house is not identified as three of a kind.
     * The hand should be identified as a full house instead.
     */
    @Test
    ...
    /**
     * Tests that four of a kind is correctly identified with five cards.
    ...
    /**
     * Tests that a pair is correctly identified with five cards.
     * A pair is a hand that contains two cards of one rank and three cards of three different ranks.
     */
    @Test
    ...
    /**
     * Tests that a hand with two pairs is not identified as a single pair.
     * The hand should be identified as two pairs instead.
     */
    @Test
    ...
    /**
     * Tests that a full house is not identified as a pair.
     * The hand should be identified as a full house instead.
     */
    @Test
    ...
    /**
     * Tests that four of a kind is not identified as a pair.
     * The hand should be identified as four of a kind instead.
     */
    @Test
    ...
    /**
     * Tests that two pairs are correctly identified.
     * Two pairs is a hand that contains two cards of one rank, two cards of another rank, and one card of a third rank.
     */
    @Test
    ...
    /**
     * Tests that a full house is not identified as two pairs.
     * The hand should be identified as a full house instead.
     */
    @Test
    ...
    /**
     * Tests that four of a kind is not identified as two pairs.
     * The hand should be identified as four of a kind instead.
     */
    @Test
