...
public abstract class PassiveJoker extends Joker {
    ...
    /**
     * Abstract method of Joker to trigger when it is deleted. To be called when a passive bonus
     * should be removed from a {@JavatroCore} parameter. Overriden by Joker subclasses.
     *
