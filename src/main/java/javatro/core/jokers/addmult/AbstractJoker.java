...
public class AbstractJoker extends Joker {
    ...
    public AbstractJoker() {
        ...
        description = String.format("%s%s+3 Mult%s%s for each %s%sJoker%s%s card held (Currently %s%s+%d%s%s Mult)",
                RED, BOLD, END, BLACK_B, YELLOW, BOLD, END, BLACK_B, RED, BOLD, numberOfJokers * 3, END, BLACK_B);
    ...
    public void interact(Score scoreClass, Card playedCard) {
        ...
        description = String.format("%s%s+3 Mult%s%s for each %s%sJoker%s%s card held (Currently %s%s+%d Mult%s%s)",
                RED, BOLD, END, BLACK_B, YELLOW, BOLD, END, BLACK_B, RED, BOLD, numberOfJokers * 3, END, BLACK_B);
