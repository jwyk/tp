...
/**
 * The {@code PlayDiscardScreen} class represents an abstract screen where users select cards from
 ...
 */
public class PlayDiscardScreen extends Screen {
    ...
    /** Constructs a {@code PlayDiscardScreen} and initializes it with a resume game command. */
    public PlayDiscardScreen() throws JavatroException {
        super("SELECT CARDS");
