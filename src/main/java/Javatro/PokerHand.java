...
public class PokerHand {
    // evaluateHand Method: This method takes an ArrayList of Card objects and evaluates the poker hand based on the rules provided.
    ...
    // The isStraight method checks whether the given hand of five cards forms a consecutive sequence
    private static boolean isStraight(Map<Card.Rank, Integer> rankCount) {
        // rankCount.keySet() gets the unique card ranks in the hand.
        List<Card.Rank> ranks = rankCount.keySet().stream()
