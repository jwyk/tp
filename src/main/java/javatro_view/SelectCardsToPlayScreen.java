...
/**
 * The {@code SelectCardsToPlayScreen} class represents a screen where the user
 * selects cards to play. It extends {@code SelectionScreen} and allows selecting
 * up to a predefined limit of cards.
 */
public class SelectCardsToPlayScreen extends SelectionScreen {

    /**
     * Constructs a {@code SelectCardsToPlayScreen} and sets the selection limit.
     * Allows selecting up to 5 cards to play and initializes the selection command.
     */
